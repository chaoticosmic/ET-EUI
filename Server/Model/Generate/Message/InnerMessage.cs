...
namespace ET
{
	...
	[ResponseType(nameof(M2G_RequestEnterGameStae))]
	...
	[Message(InnerOpcode.M2G_RequestEnterGameStae)]
	[ProtoContract]
	public partial class M2G_RequestEnterGameStae: Object, IActorLocationResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
